...
void ClientWindow::setView(){
    ...
    listWidgetRicerca->setGeometry(QRect(255, 120, 311, 321));
    labelRicercaUsername->setGeometry(QRect(288, 80, 91, 20));
    labelRicercaUser->setGeometry(QRect(400, 80, 121, 21));
    lineEditRicercaUsername->setGeometry(QRect(50, 200, 131, 21));
    lineEditRicercaUsername->setClearButtonEnabled(true);
    pushButtonRicerca->setGeometry(QRect(60, 230, 115, 32));
    pushButtonAggiungiContatto->setGeometry(QRect(320, 480, 181, 32));
